...
namespace OnlineKF.Utils
{
    ...
    public class DataTableHelper
    {
        ...
        /// </summary>
        /// <param name="dt"></param>
        /// <param name="startInd">起始Index,包含这个位置</param>
        /// <param name="len">长度</param>
        /// <returns></returns>
        public static DataTable CutDataTable(DataTable dt,int startInd, int len)
        {
            if (dt == null || dt.Rows.Count < startInd + len)
                return null;
            DataTable result = dt.Clone();
            int oriLen = dt.Rows.Count;
